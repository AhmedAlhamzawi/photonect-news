#!/usr/bin/env python3
"""Fetch real Commons portraits of named newsmakers for 2026-06-01.
...
FACES = [
    ("Christine_Lagarde", "2026-06-01-ecb-rate-hike/broll_1.jpg"),
    ("Saad_Sherida_al-Kaabi", "2026-06-01-qatar-lng-expansion/broll_1.jpg"),
]
