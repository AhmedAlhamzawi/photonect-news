#!/usr/bin/env python3
"""Post-copywriter verification for the 2026-09-09 slate.
...
after publication:
  ...
  4. exactly 2 statPops per brief, each matchWord matching EXACTLY ONE timing word.
     ...
     silently dropped. That is how 2026-09-09 slug B shipped with pops=1: the
  ...
  7. NUMBER DRIFT: the SET of distinct digit-runs in the shipped files is
     compared against the authored originals (imported from author_2026_09_09,
