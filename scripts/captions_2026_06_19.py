#!/usr/bin/env python3
"""Build ready-to-paste Arabic IG captions (caption.txt) for the 2026-06-19 slate
...
TAGS = {
    "iraq-budget-bypass": ["#العراق", "#موازنة_العراق", "#بغداد", "#اقتصاد_العراق", "#البنك_المركزي"],
    "worldcup-goal-deluge": ["#كأس_العالم", "#مونديال_2026", "#كرة_القدم", "#أهداف", "#WorldCup2026"],
    "saudi-tourism-2030": ["#السعودية", "#السياحة", "#رؤية_2030", "#نيوم", "#العلا", "#Vision2030"],
    "preservatives-heart": ["#صحة", "#القلب", "#تغذية", "#ضغط_الدم", "#مواد_حافظة"],
    "stargate-uae-ai": ["#الإمارات", "#الذكاء_الاصطناعي", "#أبوظبي", "#تقنية", "#StargateUAE", "#AI"],
    "amazon-fungus-spider": ["#علوم", "#الأمازون", "#اكتشاف", "#طبيعة", "#عناكب", "#Science"],
}
