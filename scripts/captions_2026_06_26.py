#!/usr/bin/env python3
"""Build ready-to-paste Arabic IG captions (caption.txt) for the 2026-06-26 slate
...
TAGS = {
    "telesurgery-athens-wuhan": ["#طب", "#جراحة_عن_بعد", "#تقنية", "#اليونان", "#ابتكار"],
    "iraq-fiscal-crisis": ["#العراق", "#الموازنة", "#الدينار", "#البنك_المركزي", "#اقتصاد"],
    "worldcup-arab-teams": ["#كأس_العالم", "#المنتخبات_العربية", "#المغرب", "#مونديال_2026", "#كرة_القدم"],
    "iran-iaea-inspections": ["#إيران", "#الوكالة_الذرية", "#التفتيش_النووي", "#غروسي", "#الشرق_الأوسط"],
    "carmel-cave-prehistory": ["#علوم", "#آثار", "#تطور_الإنسان", "#اكتشاف", "#تاريخ"],
    "riyadh-air-launch": ["#طيران_الرياض", "#السعودية", "#طيران", "#رؤية_2030", "#الخليج"],
}
