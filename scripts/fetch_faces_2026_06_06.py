#!/usr/bin/env python3
"""Fetch real Commons portraits of named newsmakers for 2026-06-06.
Muqtada al-Sadr -> iraq-new-government broll_3 (he IS the named cleric who announced
folding Saraya al-Salam into the national command structure)."""
import sys
...
FACES = [
    ("Muqtada_al-Sadr", "2026-06-06-iraq-new-government/broll_3.jpg"),
]
