#!/usr/bin/env python3
"""Fetch real Commons/Wikipedia portraits for the named people in the 2026-07-02 slate.
...
FACES = [
    ("Ali al-Zaidi",           "2026-07-02-iraq-us-chevron-pivot", "hero.jpg"),
    ("Brad Cooper (admiral)",  "2026-07-02-centcom-bahrain-summit", "broll_1.jpg"),
    ("Michael Jackson",        "2026-07-02-michael-biopic-record",  "hero.jpg"),
    ("Lee Jae-myung",          "2026-07-02-skorea-chip-megaplan",   "broll_1.jpg"),
]
...
def main():
    ...
    (IMG / "_faces_missing_0702.json").write_text(json.dumps([[s, sl] for _, s, sl in miss]))
