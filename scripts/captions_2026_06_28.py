#!/usr/bin/env python3
"""Build ready-to-paste Arabic IG captions (caption.txt) for the 2026-06-28 slate
...
TAGS = {
    "iraq-greenzone-arrests": ["#العراق", "#المنطقة_الخضراء", "#مكافحة_الفساد", "#بغداد", "#الزيدي"],
    "ufc-baku-fiziev": ["#UFC", "#فيزيف", "#باكو", "#فنون_قتالية", "#رياضة"],
    "sudan-burhan-deadlock": ["#السودان", "#البرهان", "#الدعم_السريع", "#وقف_النار", "#الخرطوم"],
    "exoplanets-superpuff": ["#علوم", "#فلك", "#كواكب", "#اكتشاف", "#الفضاء"],
    "uae-etihad-rail": ["#الإمارات", "#الاتحاد_للقطارات", "#قطار", "#أبوظبي", "#البنية_التحتية"],
    "toystory5-record": ["#توي_ستوري", "#سينما", "#شباك_التذاكر", "#ديزني", "#أفلام"],
}
