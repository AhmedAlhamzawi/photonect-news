...
HTML_FILE = os.path.abspath("iran_war_apr10.html")
OUTPUT_DIR = os.path.abspath("iran_apr10_slides")
...
SLIDES = [
    ("slide-1", "01_cover"),
    ("slide-2", "02_ceasefire"),
    ("slide-3", "03_lebanon"),
    ("slide-4", "04_hormuz"),
    ("slide-5", "05_islamabad"),
    ("slide-6", "06_nuclear"),
    ("slide-7", "07_whats_next"),
]
