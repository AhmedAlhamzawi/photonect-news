...
OUTPUT_DIR = "/Users/ahmed/Desktop/Photonect NEWS/NEWS CODE/slides_v8"
HTML_PATH = "file:///Users/ahmed/Desktop/Photonect%20NEWS/NEWS%20CODE/iraq_v8.html"
...
async def render():
    ...
    await asyncio.sleep(4)  # Wait for fonts to load
    ...
    for i in range(1, 7):
        ...
        if element:
            ...
            print(f"✓ Rendered slide {i} → {out_path}")
        else:
